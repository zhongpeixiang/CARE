...
def model_opts(parser):
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='rnn',
              choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn', 'kg_transformer'],
              help="Type of encoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|brnn|mean|transformer|cnn|kg_transformer].")
    group.add('--decoder_type', '-decoder_type', type=str, default='rnn',
              choices=['rnn', 'transformer', 'cnn', 'eds', 'kg_transformer'],
              help="Type of decoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|transformer|cnn|eds|kg_transformer].")
    group.add('--eds_type', '-eds_type', type=int, default=0,
              choices=[0,1,2,3], 
              help="Type of EDSDecoder to compute output probs.")
    group.add('--no_eds_attention', '-no_eds_attention', action="store_true",
              help="Remove lexicon attention in the decoder.")
    group.add('--no_clf_loss', '-no_clf_loss', action="store_true",
              help="Remove emotion classification loss in the loss function.")
    group.add('--tgt_concept_type', '-tgt_concept_type', type=int, default=-1,
              choices=[-1,0,1,2,3], 
              help="Type of EDSDecoder to compute output probs for concept embeddings.")
    group.add('--tgt_concept_words_type', '-tgt_concept_words_type', type=int, default=-1,
              choices=[-1,0,1,2,3], 
              help="Type of EDSDecoder to compute output probs for concept words.")
...
def train_opts(parser):
    ...
    group.add('--num_emotion_classes', '-num_emotion_classes', type=int, default=0, 
              help="Number of emotions to model")
    group.add('--emotion_emb_size', '-emotion_emb_size', type=int, default=0, 
              help="The size of emotion embedding")
    group.add('--train_emotion_path', '-train_emotion_path', type=str, default="", 
              help="The file path to the emotions of the training target")
    group.add('--valid_emotion_path', '-valid_emotion_path', type=str, default="", 
              help="The file path to the emotions of the validation target")

    group.add('--emotion_lexicon', '-emotion_lexicon', type=str, default="", 
              help="The file path to the emotion lexicon in EDS model")
    group.add('--lambda_', '-lambda_', type=float, default=0.01, 
              help="The weight coeffificent for classification loss in EDS model")
    
    group.add('--kg_embedding_path', '-kg_embedding_path', type=str, default="", 
              help="The file path to the pretrained knowledge graph embedding")
    group.add('--kg_vocab_dir', '-kg_vocab_dir', type=str, default="", 
              help="The dir to the entity2id.txt and relation2id.txt for augmented ConceptNet")
    group.add('--train_src_concept_path', '-train_src_concept_path', type=str, default="", 
              help="The file path to the concepts in the training src split")
    group.add('--valid_src_concept_path', '-valid_src_concept_path', type=str, default="", 
              help="The file path to the concepts in the validation src split")
    group.add('--train_src_concept_embedding', '-train_src_concept_embedding', type=str, default="", 
              help="The file path to the concept embedding in the training src split")
    group.add('--valid_src_concept_embedding', '-valid_src_concept_embedding', type=str, default="", 
              help="The file path to the concept embedding in the validation src split")
    group.add('--train_tgt_concept_embedding', '-train_tgt_concept_embedding', type=str, default="", 
              help="The file path to the concept embedding in the training tgt split")
    group.add('--valid_tgt_concept_embedding', '-valid_tgt_concept_embedding', type=str, default="", 
              help="The file path to the concept embedding in the validation tgt split")
    group.add('--train_tgt_concept_words', '-train_tgt_concept_words', type=str, default="", 
              help="The file path to the concept words in the training tgt split")
    group.add('--valid_tgt_concept_words', '-valid_tgt_concept_words', type=str, default="", 
              help="The file path to the concept words in the validation tgt split")
    # Init options
    ...
    group.add('--boc_coefficient', '-boc_coefficient', type=float, default=0,
              help="The loss weight for bag of concept loss in kg_transformer")
    group.add('--boc_step_size', '-boc_step_size', type=float, default=0,
              help="The step size of the boc loss weight in kg_transformer")
    ...
    group.add('--config_id', '-config_id', type=int, required=True,
              help="Configuration id for the experiment for logging.")
...
def translate_opts(parser):
    ...
    group.add('--share_vocab', '-share_vocab', action='store_true',
              help="Share source and target vocabulary")
    group.add('--target_emotions_path', '-target_emotions_path', type=str, default="",
              help="The file path to input emotions during translation")
    group.add('--emotion_lexicon', '-emotion_lexicon', type=str, default="", 
              help="The file path to the emotion lexicon in EDS model")
    group.add('--rerank', '-rerank', action='store_true',
              help="Rerank translations based on emotion and relevance.")
    group.add('--target_concept_embedding', '-target_concept_embedding', type=str, default="",
              help="The file path to tgt concept embedding during translation")
    group.add('--target_concept_words', '-target_concept_words', type=str, default="",
              help="The file path to tgt concept words during translation")
    ...
    group.add('--emotion_topk_decoding_temp', '-emotion_topk_decoding_temp',
              default=0.0, type=float,
              help="Emotional topk decoding temperature")
